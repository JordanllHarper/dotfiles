...
# macos_notification_count.sh {
	...
	# sqlite3 -list "/var/folders/cc/j4c6_z9517g9tgr2wtq4q98njk4jhs/0//com.apple.notificationcenter/db/db" 'select * from app_info'
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/Users/jordanh/.mail/inbox/new"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/Users/jordanh/.mailcheckrc"
# }
