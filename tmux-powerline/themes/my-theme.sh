...
DEFAULT_SEGMENT_COLOR="#24283b"

if [ -z $TMUX_POWERLINE_LEFT_STATUS_SEGMENTS ]; then
	TMUX_POWERLINE_LEFT_STATUS_SEGMENTS=(
		"tmux_session_info ${DEFAULT_SEGMENT_COLOR} #2ac3de" \
		"hostname ${DEFAULT_SEGMENT_COLOR} #9ece6a ${TMUX_POWERLINE_SEPARATOR_RIGHT_BOLD}" \
		#"ifstat 30 255" \
		#"ifstat_sys 30 255" \
		# "lan_ip 24 255 ${TMUX_POWERLINE_SEPARATOR_RIGHT_THIN}" \
		# "wan_ip 24 255" \
		"vcs_branch ${DEFAULT_SEGMENT_COLOR} #7aa2f7" \
		#"vcs_compare 60 255" \
		#"vcs_staged 64 255" \
		#"vcs_modified 9 255" \
		#"vcs_others 245 0" \
...
if [ -z $TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS ]; then
	TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS=(
		#"earthquake 3 0" \
		"pwd ${DEFAULT_SEGMENT_COLOR} 211" \
		#"macos_notification_count 29 255" \
		#"mailcount 9 255" \
		"now_playing ${DEFAULT_SEGMENT_COLOR} #f7768e ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}" \
		#"cpu 240 136" \
		# "load ${DEFAULT_SEGMENT_COLOR} 167 ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}" \
		#"tmux_mem_cpu_load 234 136" \
		"battery ${DEFAULT_SEGMENT_COLOR} #f7768e ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}" \
        #"air ${TMUX_POWERLINE_SEG_AIR_COLOR} 255" \
		# "weather ${DEFAULT_SEGMENT_COLOR} 255 ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}" \
		#"rainbarf 0 ${TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR}" \
		#"xkb_layout 125 117" \
		"date_day ${DEFAULT_SEGMENT_COLOR} #e0af68 ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}" \
		"date ${DEFAULT_SEGMENT_COLOR} #e0af68 ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}" \
		"time ${DEFAULT_SEGMENT_COLOR} #e0af68 ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}" \
